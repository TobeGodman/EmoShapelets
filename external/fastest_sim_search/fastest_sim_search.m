...
% The code may produce imaginary numbers due to numerical errors for long time series where batch 
% processing on short segments can solve the problem.

function dist = fastest_sim_search(x,y)
